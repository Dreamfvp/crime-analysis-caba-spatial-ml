...
## 🚀 What is crime-analysis-caba-spatial-ml?
...
1. Look for the newest version, usually at the top. The version number looks like “v1.0” or similar.
2. Find the attached file for Windows. It typically ends with `.exe` or `.zip`.
...
- If it is a `.exe` file, this is the installer.
- If it is a `.zip` file, save it and extract its contents after downloading.

---

### Step 4: Run the Installer or Program

- If you downloaded an `.exe` installer: double-click it and follow the prompts.
- If you downloaded a `.zip` archive: open the folder and double-click the main `.exe` file.
...
2. The main screen will load a map of Buenos Aires, focusing on Palermo.
3. Use the menu on the left to select crime types, dates, or predictive models.
4. Click “Run Analysis” to see hotspots on the map.
5. Zoom and click on areas to get detailed information.
...
## 🔧 Technical Info for Interested Users
...
1. Return to the release page using the download button above.
2. Download the new installer or archive.
